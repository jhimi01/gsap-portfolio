  ...
  return (
    ...
    >
      <div className="container">
        <div style={{ marginBottom: "6rem" }} className="services-intro">
          <p
            style={{
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="service-arrow" style={{ opacity: 0.3 }}>
                <MoveUpRight size={40} strokeWidth={1.5} />
              </div>
      ...
      <style>{`
        @media (max-width: 768px) {
          ...
          .services-intro { margin-bottom: 4rem !important; }
          .service-item { 
